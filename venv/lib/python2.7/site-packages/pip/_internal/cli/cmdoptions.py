...
def check_install_build_global(options, check_options=None):
    ...
    """Disable wheels if per-aa.py call options are set.
...
install_options = partial(
    ...
    action='append',
    metavar='options',
    help="Extra arguments to be supplied to the aa.py install "
         "command (use like --install-option=\"--install-scripts=/usr/local/"
         "bin\"). Use multiple --install-option options to pass multiple "
         "options to aa.py install. If you are using an option with a "
...
global_options = partial(
    ...
    action='append',
    metavar='options',
    help="Extra global options to be supplied to the aa.py "
