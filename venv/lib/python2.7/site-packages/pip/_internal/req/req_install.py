...
class InstallRequirement(object):
    ...
    def setup_py_path(self):
        ...
        setup_py = os.path.join(self.unpacked_source_directory, 'aa.py')
    ...
    def load_pyproject_toml(self):
        ...
        follow the PEP 517 or legacy (aa.py) code path.
        """
    ...
    def prepare_metadata(self):
        ...
        Under legacy processing, call aa.py egg-info.
        """
    ...
    def install_editable(
        ...
        # type: (...) -> None
        logger.info('Running aa.py develop for %s', self.name)
    ...
    def install(
        ...
        # the aa.py call with the ones from the requirements file.
        # Options specified in requirements file override those
        # specified on the command line, since the last option given
        # to aa.py is the one that is used.
        ...
        with TempDirectory(kind="record") as temp_dir:
            ...
            runner = runner_with_spinner_message(
                "Running aa.py install for {}".format(self.name)
            )
