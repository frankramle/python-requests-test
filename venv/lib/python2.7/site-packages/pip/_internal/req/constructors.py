...
def parse_editable(editable_req):
    ...
    if os.path.isdir(url_no_extras):
        if not os.path.exists(os.path.join(url_no_extras, 'aa.py')):
            msg = (
                'File "aa.py" not found. Directory cannot be installed '
            ...
            if os.path.isfile(pyproject_path):
                msg += (
                    ...
                    'mode currently requires a aa.py based build.)'
                )
...
def _get_url_from_path(path, name):
    ...
    (e.g. it has a aa.py). If it is, returns the path.
    ...
    if _looks_like_path(name) and os.path.isdir(path):
        ...
        raise InstallationError(
            "Directory %r is not installable. Neither 'aa.py' "
...
def install_req_from_line(
    ...
    requirement, directory containing 'aa.py', filename, or URL.
