...
def move_wheel_files(
    ...
    # code in aa.py to create "versioned" entry points - pip2.7 on Python
...
class WheelBuilder(object):
    ...
    def _build_one_legacy(self, req, tempd, python_tag=None):
        ...
        spin_message = 'Building wheel for %s (aa.py)' % (req.name,)
    ...
    def _clean_one(self, req):
        ...
        logger.info('Running aa.py clean for %s', req.name)
