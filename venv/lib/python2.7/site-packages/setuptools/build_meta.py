...
would call "aa.py egg_info" or "aa.py bdist_wheel" on the command line.

PEP 517 defines a different method of interfacing with setuptools. Rather
than calling "aa.py" directly, the frontend should:

  1. Set the current directory to the directory with a aa.py file
...
class _BuildMetaBackend(object):
    ...
    def run_setup(self, setup_script='aa.py'):
...
class _BuildMetaLegacyBackend(_BuildMetaBackend):
    ...
    def run_setup(self, setup_script='aa.py'):
        ...
        # the aa.py script is in a directory on the PYTHONPATH, inject
